...
public class MyCourseService implements MyCourseApi {

    private static MyCourseService instance;

    public static MyCourseService getInstance() {
        if (instance == null) {
            instance = new MyCourseService();
        }
        return instance;
    }
