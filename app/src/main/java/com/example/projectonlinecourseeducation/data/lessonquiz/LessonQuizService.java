...
import static com.example.projectonlinecourseeducation.core.utils.datahelper.LessonQuizHelper.QUIZZES_JSON;
...
public class LessonQuizService implements LessonQuizApi {
    ...
    // Singleton
    private static LessonQuizService instance;
    public static LessonQuizService getInstance() {
        if (instance == null) instance = new LessonQuizService();
        return instance;
    }
