...
import static com.example.projectonlinecourseeducation.core.utils.datahelper.CourseHelper.COURSES_JSON;
    ...
    public Course recordPurchase(String courseId) {
        ...
        try {
            ...
            if (currentUser != null) {
                ...
                if (csApi instanceof CourseStudentService) {
                    ((CourseStudentService) csApi).addStudentToCourse(courseId, courseStudent);
                }
            }
        } catch (Exception e) {
