...
import static com.example.projectonlinecourseeducation.core.utils.datahelper.LessonCommentHelper.COMMENTS_JSON;
...
public class LessonCommentService implements LessonCommentApi {

    private static LessonCommentService instance;
    ...
    private LessonCommentService() {
        seedFromJson();
    }

    public static synchronized LessonCommentService getInstance() {
        if (instance == null) {
            instance = new LessonCommentService();
        }
        return instance;
    }
